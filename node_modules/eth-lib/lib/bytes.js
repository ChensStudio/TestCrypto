...
var random = function random(bytes) {
  var rnd = void 0;
  if (typeof window !== "undefined" && window.crypto && window.crypto.getRandomValues) rnd = window.crypto.getRandomValues(new Uint8Array(bytes));else if (typeof require !== "undefined") rnd = global.crypto.randomBytes(bytes);else throw "Safe random numbers not available.";
  var hex = "0x";
